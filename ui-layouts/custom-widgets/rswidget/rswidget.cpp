...
RsWidget::RsWidget(std::string i, QWidget *parent) :
        QDialog(parent),
        ui(new Ui::RsWidget)
{
    ui->setupUi(this);
...
void RsWidget::updateIndividual(std::string txt){
...
CustomWidgetInterface* createRsWidget(QWidget* parent, std::string i){
    return  static_cast<CustomWidgetInterface*>(new RsWidget(i, parent));
}
