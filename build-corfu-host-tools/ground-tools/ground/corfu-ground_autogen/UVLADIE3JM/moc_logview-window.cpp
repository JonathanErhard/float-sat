/****************************************************************************
** Meta object code from reading C++ file 'logview-window.hpp'
**
...
#include <memory>
#include "../../../../../corfu/dev-host/ground-tools/ground/src/logview-window.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'logview-window.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 6), // "newLog"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "Log&"
QT_MOC_LITERAL(4, 27, 1) // "l"

    },
    "LogViewWindow\0newLog\0\0Log&\0l"
};
...
void LogViewWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LogViewWindow *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->newLog((*reinterpret_cast< Log(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject LogViewWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_LogViewWindow.data,
    qt_meta_data_LogViewWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
