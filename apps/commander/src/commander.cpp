...
void Commander::runCommandThread()
{
    ...
    {
        if (corfuUplinkTelecommandTopicFifo.isEmpty())
            break;
        ...
        if (tc.timeToExecute == 0u)
        { // immediate command @LINKEDREQ CMD_09
...
bool Commander::handleTelecommandSearchObject()
{
    // TODO
    return true;
}
bool Commander::handleTelecommandTrackObject()
{
    // TODO
    return true;
}*/
